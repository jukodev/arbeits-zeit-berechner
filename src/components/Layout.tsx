...
export default function Layout() {
	return (
		<div className="flex h-full pt-12 flex-col bg-[#f2f2f7] dark:bg-black safe-top safe-x">
			...
			{/* Tab bar */}
			<nav className="fixed inset-x-0 bottom-0 z-40 border-t pb-4 border-gray-300/60 bg-[#f2f2f7]/80 backdrop-blur-xl dark:border-white/[0.08] dark:bg-black/80 safe-bottom safe-x">
